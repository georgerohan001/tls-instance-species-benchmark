...
- `PredInstance` — manual inventory-matched stem id
...
Use a stable integer per inventory stem (one PredInstance ↔ one stem). Example schemes:

- Composite plot/tree codes (e.g. plot × 1000 + tree)
